        ...
        <div className="max-w-[1440px] mx-auto px-[2rem] py-[1rem]">
          ...
          <main className="flex flex-col mt-12">
            ...
            >
              ...
              <div className="grid grid-cols-4 grid-rows-2 justify-center justify-items-center gap-16 gap-y-6">
            ...
            <section
              className="flex flex-col justify-center gap-8 mb-44 pt-20"
              id="section-3"
            >
              <div className="flex flex-col items-center gap-3">
                {" "}
            ...
            <section className="flex flex-col gap-8 mb-44 pt-20" id="section-4">
              <div className="flex flex-col items-center gap-3">
                {" "}
                <span>
                  <svg
