      ...
      <contain className="">
        <div className="max-w-[1440px] mx-auto px-[2rem] py-[1rem]">
          ...
          <main className="flex flex-col mt-12">
            ...
            <section
              className="flex justify-center items-center flex-col gap-8 mb-44 pt-20"
              id="section-2"
            >
            ...
            <section className="flex flex-col justify-center gap-8 mb-44 pt-20" id="section-">
              <div className="flex flex-col items-center gap-3">
                {" "}
                <span>
                  <svg
            ...
            <section className="flex flex-col gap-8 mb-44 pt-20" id="section-">
              <div className="flex flex-col items-center gap-3">
                {" "}
                <span>
                  <svg
            ...
            <section className="flex flex-col justify-between items-center mb-44 pt-20" id="section-">
